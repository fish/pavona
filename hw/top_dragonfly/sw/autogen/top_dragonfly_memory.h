...
#ifndef OPENTITAN_HW_TOP_DRAGONFLY_SW_AUTOGEN_TOP_DRAGONFLY_MEMORY_H_
#define OPENTITAN_HW_TOP_DRAGONFLY_SW_AUTOGEN_TOP_DRAGONFLY_MEMORY_H_
...
/**
 * Memory base for ctn memory on soc_proxy in top dragonfly.
 */
#define TOP_DRAGONFLY_SOC_PROXY_CTN_BASE_ADDR 0x40000000
 ...
 */
#define TOP_DRAGONFLY_SRAM_CTRL_RET_AON_RAM_SIZE_BYTES 0x1000

/**
 * Memory base for ram memory on sram_ctrl_main in top dragonfly.
 */
#define TOP_DRAGONFLY_SRAM_CTRL_MAIN_RAM_BASE_ADDR 0x10000000

/**
 * Memory size for ram memory on sram_ctrl_main in top dragonfly.
 */
#define TOP_DRAGONFLY_SRAM_CTRL_MAIN_RAM_SIZE_BYTES 0x10000

/**
 * Memory base for ram memory on sram_ctrl_mbox in top dragonfly.
 */
#define TOP_DRAGONFLY_SRAM_CTRL_MBOX_RAM_BASE_ADDR 0x11000000

/**
 * Memory size for ram memory on sram_ctrl_mbox in top dragonfly.
 */
#define TOP_DRAGONFLY_SRAM_CTRL_MBOX_RAM_SIZE_BYTES 0x1000

/**
 * Memory base for rom memory on rom_ctrl0 in top dragonfly.
 */
#define TOP_DRAGONFLY_ROM_CTRL0_ROM_BASE_ADDR 0x8000

/**
 * Memory size for rom memory on rom_ctrl0 in top dragonfly.
 */
#define TOP_DRAGONFLY_ROM_CTRL0_ROM_SIZE_BYTES 0x8000

/**
 * Memory base for rom memory on rom_ctrl1 in top dragonfly.
 */
#define TOP_DRAGONFLY_ROM_CTRL1_ROM_BASE_ADDR 0x20000

/**
 * Memory size for rom memory on rom_ctrl1 in top dragonfly.
 */
#define TOP_DRAGONFLY_ROM_CTRL1_ROM_SIZE_BYTES 0x10000
 ...
 */
#define TOP_DRAGONFLY_UART0_BASE_ADDR 0x30010000
 ...
 */
#define TOP_DRAGONFLY_UART0_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_GPIO_BASE_ADDR 0x30000000
 ...
 */
#define TOP_DRAGONFLY_GPIO_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_SPI_DEVICE_BASE_ADDR 0x30310000
 ...
 */
#define TOP_DRAGONFLY_SPI_DEVICE_SIZE_BYTES 0x2000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_I2C0_BASE_ADDR 0x30080000
 ...
 */
#define TOP_DRAGONFLY_I2C0_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_RV_TIMER_BASE_ADDR 0x30100000
 ...
 */
#define TOP_DRAGONFLY_RV_TIMER_SIZE_BYTES 0x200
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_OTP_CTRL_CORE_BASE_ADDR 0x30130000
 ...
 */
#define TOP_DRAGONFLY_OTP_CTRL_CORE_SIZE_BYTES 0x10000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_OTP_MACRO_PRIM_BASE_ADDR 0x30140000
 ...
 */
#define TOP_DRAGONFLY_OTP_MACRO_PRIM_SIZE_BYTES 0x20
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_LC_CTRL_REGS_BASE_ADDR 0x30150000
 ...
 */
#define TOP_DRAGONFLY_LC_CTRL_REGS_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_ALERT_HANDLER_BASE_ADDR 0x30160000
 ...
 */
#define TOP_DRAGONFLY_ALERT_HANDLER_SIZE_BYTES 0x800
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_SPI_HOST0_BASE_ADDR 0x30300000
 ...
 */
#define TOP_DRAGONFLY_SPI_HOST0_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_PWRMGR_AON_BASE_ADDR 0x30400000
 ...
 */
#define TOP_DRAGONFLY_PWRMGR_AON_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_RSTMGR_AON_BASE_ADDR 0x30410000
 ...
 */
#define TOP_DRAGONFLY_RSTMGR_AON_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_CLKMGR_AON_BASE_ADDR 0x30420000
 ...
 */
#define TOP_DRAGONFLY_CLKMGR_AON_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_PINMUX_AON_BASE_ADDR 0x30460000
 ...
 */
#define TOP_DRAGONFLY_PINMUX_AON_SIZE_BYTES 0x800
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_AON_TIMER_AON_BASE_ADDR 0x30470000
 ...
 */
#define TOP_DRAGONFLY_AON_TIMER_AON_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_AST_BASE_ADDR 0x30480000
 ...
 */
#define TOP_DRAGONFLY_AST_SIZE_BYTES 0x400
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_SOC_PROXY_CORE_BASE_ADDR 0x22030000
 ...
 */
#define TOP_DRAGONFLY_SOC_PROXY_CORE_SIZE_BYTES 0x8
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_SRAM_CTRL_RET_AON_REGS_BASE_ADDR 0x30500000
 ...
 */
#define TOP_DRAGONFLY_SRAM_CTRL_RET_AON_REGS_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_RV_DM_REGS_BASE_ADDR 0x21200000
 ...
 */
#define TOP_DRAGONFLY_RV_DM_REGS_SIZE_BYTES 0x10
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_RV_DM_MEM_BASE_ADDR 0x40000
 ...
 */
#define TOP_DRAGONFLY_RV_DM_MEM_SIZE_BYTES 0x1000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_RV_PLIC_BASE_ADDR 0x28000000
 ...
 */
#define TOP_DRAGONFLY_RV_PLIC_SIZE_BYTES 0x8000000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_ACC_BASE_ADDR 0x22100000
 ...
 */
#define TOP_DRAGONFLY_ACC_SIZE_BYTES 0x20000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_AES_BASE_ADDR 0x21100000
 ...
 */
#define TOP_DRAGONFLY_AES_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_HMAC_BASE_ADDR 0x21110000
 ...
 */
#define TOP_DRAGONFLY_HMAC_SIZE_BYTES 0x2000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_KMAC_BASE_ADDR 0x21120000
 ...
 */
#define TOP_DRAGONFLY_KMAC_SIZE_BYTES 0x1000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_KEYMGR_DPE_BASE_ADDR 0x21140000
 ...
 */
#define TOP_DRAGONFLY_KEYMGR_DPE_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_CSRNG_BASE_ADDR 0x21150000
 ...
 */
#define TOP_DRAGONFLY_CSRNG_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_ENTROPY_SRC_BASE_ADDR 0x21160000
 ...
 */
#define TOP_DRAGONFLY_ENTROPY_SRC_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_EDN0_BASE_ADDR 0x21170000
 ...
 */
#define TOP_DRAGONFLY_EDN0_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_EDN1_BASE_ADDR 0x21180000
 ...
 */
#define TOP_DRAGONFLY_EDN1_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_SRAM_CTRL_MAIN_REGS_BASE_ADDR 0x211C0000
 ...
 */
#define TOP_DRAGONFLY_SRAM_CTRL_MAIN_REGS_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_SRAM_CTRL_MBOX_REGS_BASE_ADDR 0x211D0000
 ...
 */
#define TOP_DRAGONFLY_SRAM_CTRL_MBOX_REGS_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_ROM_CTRL0_REGS_BASE_ADDR 0x211E0000
 ...
 */
#define TOP_DRAGONFLY_ROM_CTRL0_REGS_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_ROM_CTRL1_REGS_BASE_ADDR 0x211E1000
 ...
 */
#define TOP_DRAGONFLY_ROM_CTRL1_REGS_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_DMA_BASE_ADDR 0x22010000
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_MBX0_CORE_BASE_ADDR 0x22000000
 ...
 */
#define TOP_DRAGONFLY_MBX0_CORE_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_MBX1_CORE_BASE_ADDR 0x22000100
 ...
 */
#define TOP_DRAGONFLY_MBX1_CORE_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_MBX2_CORE_BASE_ADDR 0x22000200
 ...
 */
#define TOP_DRAGONFLY_MBX2_CORE_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_MBX3_CORE_BASE_ADDR 0x22000300
 ...
 */
#define TOP_DRAGONFLY_MBX3_CORE_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_MBX4_CORE_BASE_ADDR 0x22000400
 ...
 */
#define TOP_DRAGONFLY_MBX4_CORE_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_MBX5_CORE_BASE_ADDR 0x22000500
 ...
 */
#define TOP_DRAGONFLY_MBX5_CORE_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_MBX6_CORE_BASE_ADDR 0x22000600
 ...
 */
#define TOP_DRAGONFLY_MBX6_CORE_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_MBX_JTAG_CORE_BASE_ADDR 0x22000800
 ...
 */
#define TOP_DRAGONFLY_MBX_JTAG_CORE_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_MBX_PCIE0_CORE_BASE_ADDR 0x22040000
 ...
 */
#define TOP_DRAGONFLY_MBX_PCIE0_CORE_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_MBX_PCIE1_CORE_BASE_ADDR 0x22040100
 ...
 */
#define TOP_DRAGONFLY_MBX_PCIE1_CORE_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_SOC_DBG_CTRL_CORE_BASE_ADDR 0x30170000
 ...
 */
#define TOP_DRAGONFLY_SOC_DBG_CTRL_CORE_SIZE_BYTES 0x20
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DRAGONFLY_RV_CORE_IBEX_CFG_BASE_ADDR 0x211F0000
 ...
 */
#define TOP_DRAGONFLY_RV_CORE_IBEX_CFG_SIZE_BYTES 0x800
 ...
 */
#define TOP_DRAGONFLY_MMIO_BASE_ADDR 0x21100000
#define TOP_DRAGONFLY_MMIO_SIZE_BYTES 0xF501000

#endif  // __ASSEMBLER__

#endif  // OPENTITAN_HW_TOP_DRAGONFLY_SW_AUTOGEN_TOP_DRAGONFLY_MEMORY_H_
